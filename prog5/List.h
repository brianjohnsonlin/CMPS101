...
void insertAtFront(ListHndl L, int data); /* Inserts new element before first
                            // Post: !isEmpty(); doesn’t change current element*/
void insertAtBack(ListHndl L, int data); /* Inserts new element after last one
                            // Post: !isEmpty(); doesn’t change current element*/
void insertBeforeCurrent(ListHndl L, int data); /* Inserts new element before current one
